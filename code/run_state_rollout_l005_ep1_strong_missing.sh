...
OUTDIR=/data1/jingyixi/wm_runs/state_rollout_l005_ep1_strong_missing
mkdir -p "$OUTDIR"
...
run_eval() {
  ...
  local out="staterollseq_${tag}_ep1_seed${seed}_h4_s1000_k100_n20.txt"
...
outdir = Path('/data1/jingyixi/wm_runs/state_rollout_l005_ep1_strong_missing')
rows = []
for p in stable.glob('staterollseq_l005_ep1_seed*_h4_s1000_k100_n20.txt'):
